...
class VisionTransformerVideoPredictor(nn.Module):
    """ Vision Transformer """
    def __init__(
        self,
        img_size=224,
...
class VisionTransformerImagePredictor(nn.Module):
    """ Vision Transformer """
    def __init__(
        self,
        num_patches,
...
def vit_predictor_video(**kwargs):
    model = VisionTransformerVideoPredictor(
        mlp_ratio=4, qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    return model

def vit_predictor_image(**kwargs):
    model = VisionTransformerImagePredictor(
        mlp_ratio=4, qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    return model
