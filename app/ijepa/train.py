...
from app.ijepa.utils import (
    load_checkpoint,
    init_model,
    init_opt)
from app.ijepa.transforms import make_transforms
...
def main(args, resume_preempt=False):
    ...
    def save_checkpoint(epoch):
        print(f'saving checkpoint for epoch: {epoch} to path: {latest_path}')
        save_dict = {
    ...
    # -- TRAINING LOOP
    print(f'start_epoch: {start_epoch}, num_epochs: {num_epochs} ipe: {ipe}')
